var search = function () {
    window.location = '/LeadUser/Index';
}
                ...
                if (response.LeadID != 0) {
                    if ($("#hndLeadID").val() == "0") {
                        $.alert({
                            ...
                            buttons: {
                                Ok: function () {
                                    window.location = '/LeadUser/Edit/' + response.LeadID;
                                }
                            }
                        });
                    }
                    ...
                    success: function (response) {
                        if ($.trim(response.error) != "") {
                            ...
                            $.alert({
                                ...
                                buttons: {
                                    Ok: function () {
                                        window.location = '/LeadUser/AddEdit';
                                    }
                                }
                            });
                        }
...
var saveVehicleLead=function()
{
    ...
    if (editRowCount>0)
    {
       ...
       //html += '<td class="pd-vehicletblText"  class="pd-editdeletetbn"><div><button  onclick="editTableRow(' + rowcount + ')"><i class="icon-pencil" ></i></button><button class="pd-btndelete"  onclick="removeTableRow(' + rowcount + ');"><i class="icon-trash"  ></i></button></div></td>';
        html += '<td class="pd-vehicletblText"  class="pd-editdeletetbn"><div><button  onclick="editTableRow(' + rowcount + ')"><i class="icon-pencil" ></i></button></div></td>';
        html += '</tr>';
...
var getVehicleMakeList = function () {
    ...
    $.ajax({
        url: "/LeadUser/GetVehicleMakeList",
        type: "post",
...
var getVehicleTypeList = function (vehicleMake) {
    ...
    $.ajax({
        url: "/LeadUser/GetVehicleTypeList",
        type: "post",
...
var getVehicleLeadData = function (leadID) {
    ...
    $.ajax({
        url: "/LeadUser/GetVehicleLeadInfo",
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
            ...
            if (response.vehicleData != "") {
                if (response.vehicleData.length > 0) {
                    ...
                    $.each(response.vehicleData, function (index, elementValue) {
                        ...
                        html += '<td class="pd-vehicletblText hidden"  data-vinno="' + elementValue.VINNO + '">' + elementValue.VINNO + '</td>';
                        html += '<td class="pd-vehicletblText hidden" data-licenseplate="' + elementValue.LicensePlate + '">' + elementValue.LicensePlate + '</td>';
                        html += '<td class="pd-vehicletblText " data-dealership="' + elementValue.DealerShip + '">' + elementValue.DealerShip + '</td>';
...
var editLead = function (id) {
    window.location = '/LeadUser/Edit/' + id;
}
...
var getEmailTemplates=function()
{
    ...
    $.ajax({
        url: '/LeadUser/GetEmailTemplates',
        type: "post",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
...
var buildPaganationLead = function () {
    ...
    $.ajax({
        url: '/LeadUser/GetLeadsFilterRangeList',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var fillLeadTable = function (PN,SO) {
    ...
    $.ajax({
        url: '/LeadUser/GetLeadInfoPageList',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var viewFiles = function () {
    ...
    var param = { LeadID: leadID };
    $.ajax({
        url: '/LeadUser/GetAttachedLeadFiles',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
