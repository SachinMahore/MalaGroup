...
namespace MalaGroupERP.Models
{
    public class LeadsModel
    {
        ...
        public LeadsModel GetLeadInfo(long LeadID)
        {
        ...
        public string SaveUpdateLead(LeadsModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
            string leadID = "0";
        ...
        public List<LeadsModel> GetLeadInfoPageList(LeadsModel model)
        {
            try
            {
                List<LeadsModel> listSearch = new List<LeadsModel>();
                MalaGroupERPEntities db = new MalaGroupERPEntities();
                DataTable dtTable = new DataTable();
                using (var cmd = db.Database.Connection.CreateCommand())
                {
        ...
        public string GetLeadsFilterRangeList(LeadsModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
        ...
        public string GetLeadAdvSearch(LeadsModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
