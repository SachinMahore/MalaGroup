var search = function () {
    window.location = '/AccountUser/Index';
}
...
var saveUpdateAccount = function () {
    ...
    $.ajax({
        url: "/AccountUser/SaveUpdateAccounts",
        type: "post",
                ...
                if (response.AccountID != 0) {
                    if ($("#hndAccountID").val() == "0") {
                        $.alert({
                            ...
                            buttons: {
                                Ok: function () {
                                    window.location = '/AccountUser/Edit/' + response.AccountID;
                                }
                            }
                        });
                    }
...
var deleteAccount = function () {
    ...
    $.confirm({
        ...
        buttons: {
            confirm: function () {
                $.ajax({
                    url: "/AccountUser/DeleteAccountData",
                    type: "post",
                    data: JSON.stringify(model),
                    contentType: "application/json; charset=utf-8", // content type sent to server
                    dataType: "json", //Expected data format from server
                    success: function (response) {
                        if ($.trim(response.error) != "") {
                            ...
                            $.alert({
                                ...
                                buttons: {
                                    Ok: function () {
                                        window.location = '/AccountUser/AddEdit';
                                    }
                                }
                            });
                        }
...
var getTransactionHistory = function (accountID) {
    ...
    $.ajax({
        url: '/AccountUser/GetTransactionHistoryDeatil',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var getTransactionDetails = function (accountID) {
    ...
    $.ajax({
        url: '/AccountUser/GetTransactionDetails',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if ($.trim(response.error) != "") {
                ...
                $.each(response, function (index, elementValue) {
                    ...
                    html += '<td style="text-align:center!important; width:200px"><input type="button" class="ibtnUpdate btn btn-md btn-primary " value="View"  id="ibtnUpdate_' + elementValue.AOID + '"  onclick="viewTransOrderDetail(' + elementValue.AOID + ')"> <input type="button" class="ibtnCancelPay btn btn-md btn-success hidden" id="ibtnCancelPayNow_' + elementValue.AOID + '" value="Cancel"  onclick="cancelPayNow(' + elementValue.AOID + ')"></td>';
                    html += '</tr>';
...
var viewTransOrderDetail = function (aoid) {
    $("#popTransDiv").PopupWindow("open");
    var param = { AOID: aoid }
    $.ajax({
        url: '/AccountUser/GetTransOrderDetails',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if ($.trim(response.error) != "") {
                ...
                $.each(response, function (index, elementValue) {
                    ...
                    html += '<td>' + elementValue.ChargeNo + '</td>';
...
var updateDateAmountTransaction = function () {
    ...
    $.ajax({
        url: '/AccountUser/UpdateDateAmountTransaction',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var setScheduleStatus = function (transType, cdID) {
    ...
    $.ajax({
        url: '/AccountUser/SetScheduleStatus',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var getTotalOrderDecal = function (aoid) {
    var param = { AOID: aoid }
    $.ajax({
        url: '/AccountUser/GetTotalOrderDecal',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if ($.trim(response.error) != "") {
                ...
                $.each(response, function (index, elementValue) {
                    ...
                    html += '<td> <input type="checkbox" id="chkAddTheft" name="radios"  disabled /></td>';
                    html += '<td> <input type="checkbox" id="chkDecals" name="radios"  disabled/></td>';
...
var editDecal = function (aoid, decimalCount) {
    ...
    for (var j = 1; j <= parseInt(decimalCount) ; j++) {
        ...
        //htmlBody += '<td class="span3"><input type="text" class="span2" id="txtVinnoUp_' + j + '" name="txtDecal"   maxlength="200" readonly></td></td>';
        htmlBody += '<td class="span3"><input type="text" class="span2" id="txtLicenseUp_' + j + '" name="txtDecal"   maxlength="200" ></td></td>';
        htmlBody += '<td class="span3"><input type="text" class="span2" id="txtDecal_' + j + '" name="txtDecal"   maxlength="200" readonly></td></td>';
        htmlBody += '<td class="span3"><input type="text" class="span2" id="txtGPSSKU_' + j + '" name="txtGPSSKU"   maxlength="200" readonly></td>';
        htmlBody += '<td class="span3"><input type="text" class="span2" id="txtGPSDN_' + j + '" name="txtGPSDN"  maxlength="200" readonly></td>';
        htmlBody += '<td class="span3"><input  class="span1" type="button" class="ibtnUpdate btn btn-md btn-primary " value="Save"  onclick="updateDecalTableRow(' + aoID + ',' + j + ')"></td>';
        htmlBody += '</tr>';
    ...
    if (decimalCount > 0) {
        $.ajax({
            url: '/AccountUser/GetDecalInfoData',
            type: "post",
            data: JSON.stringify(param),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
var updateVehicleInfo = function () {
    ...
    $.ajax({
        url: "/AccountUser/UpdateVehicleInfo",
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8", // content type sent to server
        dataType: "json", //Expected data format from server
...
var getPCCheckInfo = function (accountID) {
    var param = { AccountID: accountID };
    $.ajax({
        url: '/AccountUser/GetCardCheckInfo',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var editCardInfo = function () {
    ...
    $.ajax({
        url: '/AccountUser/EditCardCheckDetail',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var editAccount = function (id) {
    ...
    window.location = '/AccountUser/Edit/' + id;
}
var buildPaganationAccount = function () {
    ...
    $.ajax({
        url: '/AccountUser/GetAccountFilterRangeList',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var fillAccountTable = function (PN, SO) {
    ...
    $.ajax({
        url: '/AccountUser/GetAccountsList',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var importToAccount = function () {
    ...
    $.ajax({
        url: "/AccountUser/ImportToAccount",
        type: 'POST',
        data: $formData,
        dataType: 'json',
        contentType: false,
...
var exportDaily = function () {
    ...
    $.ajax({
        url: "/AccountUser/ExportDailyMail",
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var viewFiles = function () {
    ...
    var param = { AccountID: accountID };
    $.ajax({
        url: '/AccountUser/GetAttachedLeadFiles',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var getEmailTemplates = function () {
    ...
    $.ajax({
        url: '/AccountUser/GetEmailTemplates',
        type: "post",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
...
var ChargePCCard = function (aoid) {
    ...
    $.ajax({
        url: "/AccountUser/SavePaymentConsoleTrans",
        method: "post",
        data: model,
        contentType: "application/json; charset=utf-8", // content type sent to server
        dataType: "json", //Expected data format from server
...
var viewRefundOff = function () {
    ...
    $.ajax({
        url: '/AccountUser/GetRefundVoidInfo',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        ...
        success: function (response) {
            if ($.trim(response.error) != "") {
                ...
                $.each(response, function (index, elementValue) {
                    var html = '';
                    html += '<tr  class="gradeX">';
                    html += '<td> <input type="radio" name="radios" class="rdCharge" value="' + elementValue.CDID + '" /></td>';
                    html += '<td >' + (index + 1).toString() + '</td>';
                    html += '<td>' + elementValue.ChargeDate + '</td>';
                    html += '<td>$' + parseFloat(elementValue.ChargeAmt).toFixed(2) + '</td>';
                    html += '<td> ' + elementValue.TransactionID + '</td>';
...
var ChargeOppTrans = function (rvctype) {
    ...
    var param = { model: model }
    $.ajax({
        url: "/AccountUser/SaveRefundVoidInfo",
        method: "post",
        data: model,
        contentType: "application/json; charset=utf-8", // content type sent to server
        dataType: "json", //Expected data format from server
...
function getEmailHistory() {
    ...
    $.ajax({
        url: '/AccountUser/GetEmailHistory',
        type: "post",
        data: JSON.stringify(param),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
var buildAdvPaganationAccount = function () {
    ...
    $.ajax({
        url: '/AccountUser/GetAccountAdvSearch',
        type: "post",
        data: JSON.stringify(model),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
