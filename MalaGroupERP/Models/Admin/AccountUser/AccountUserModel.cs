...
namespace MalaGroupERP.Models
{
    public class AccountUserModel
    {
        ...
        public AccountUserModel GetAccountsInfo(long AccountID)
        {
            ...
            if (AccountID > 0)
            {
                ...
                using (var cmd = db.Database.Connection.CreateCommand())
                {
                    ...
                    if (dsDataSet.Tables[0] != null && dsDataSet.Tables[0].Rows.Count > 0)
                    {
                        ...
                        model.CreatedByText = dsDataSet.Tables[0].Rows[0]["CreatedById"].ToString();
                        model.LastModifiedByIdText = dsDataSet.Tables[0].Rows[0]["LastModifiedById"].ToString();
                        ...
                        model.Language = dsDataSet.Tables[0].Rows[0]["Language"].ToString();
                        model.SalesDate = salesdate.Value.ToString("MM/dd/yyyy");
        ...
        public string SaveUpdateAccounts(AccountUserModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
            string accountID = "0";
            string OldEmail = "";
            ...
            if (acctUpdate != null)
            {
                ...
                acctUpdate.LastModifiedDate = Convert.ToDateTime(DateTime.Now.ToString("MM/dd/yyyy hh:mm tt"));
        ...
        public string UpdateDecal(AccountUserModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
            string aoID = "0";
        ...
        public string SaveDecal(AccountUserModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
            string aoID = "0";
            var decalData = db.tbl_AgentOrderDetails.Where(p => p.AOID == model.AOID).FirstOrDefault();
        ...
        public string OrderToAccounts(string PinNo)
        {
            ...
            if (transUpdate != null)
            {
                    ...
                    if (ccDetails.PaymentMode == 1)
                    {
                        ...
                        if (response != null)
                        {
                            ...
                            if (statusCode == 1 && statusText == "Approved")
                            {
                                ...
                                if (body != "")
                                {
                                    new CommonModel().SendEmailPayments(card.AOModel.LeadEmail, emailSubject, body, model.AccountID);
                                    body = "";
                ...
                if (createAccount == 1)
                {
                    ...
                    if (acctExist == null)
                    {
                        var acctSave = new tbl_Accounts()
                        {
                            ...
                            IsDeleted = 0,
                            Type=model.CompType,
                            SalesDate=Convert.ToDateTime(model.FirstChargeDate),
                        };
                    ...
                    else
                    {
                        ...
                        acctExist.SalesDate = Convert.ToDateTime(model.FirstChargeDate);
                        db.SaveChanges();
                ...
                {
                    db.Dispose();
                    return "|Error Occured |Account Not Created...";
                }
            }
            else
            {
        ...
        public List<AccountUserModel> GetAccountsList(AccountUserModel model)
        {
            try
            {
                List<AccountUserModel> listSearch = new List<AccountUserModel>();
                MalaGroupERPEntities db = new MalaGroupERPEntities();
                ...
                using (var cmd = db.Database.Connection.CreateCommand())
                {
                    try
                    {
                        ...
                        foreach (DataRow dr in dtTable.Rows)
                        {
                            ...
                            listSearch.Add(new AccountUserModel()
                            {
        ...
        public List<AccountUserModel> HistoryDetail(long AccountID)
        {
            try
            {
                List<AccountUserModel> model = new List<AccountUserModel>();
                MalaGroupERPEntities db = new MalaGroupERPEntities();
                DataTable dtTable = new DataTable();
                using (var cmd = db.Database.Connection.CreateCommand())
                {
                    try
                    {
                        ...
                        foreach (DataRow dr in dtTable.Rows)
                        {
                            ...
                            model.Add(new AccountUserModel()
                            {
        ...
        public string GetAccountFilterRangeList(AccountUserModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
        ...
        public string GetAccountAdvSearch(AccountUserModel model)
        {
            MalaGroupERPEntities db = new MalaGroupERPEntities();
